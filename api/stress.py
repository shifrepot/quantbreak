            ...
            try:
                ...
                results.append({
                    ...
                    "note": (
                        ...
                        "BS CVaR = normal distribution assumption on 20-day returns. "
                        "Regime CVaR = historical simulation on 20-day returns (no dist. assumption). "
        ...
        body = json.dumps({
            ...
            "summary": {
                ...
                "method": (
                    ...
                    "BS CVaR uses normal distribution. "
                    "Regime CVaR uses historical simulation (fat tail aware). "
